...
export type GekozenWerkzaamheid = z.infer<typeof s.gekozenWerkzaamheidSchema>;
export type GekozenMateriaal = z.infer<typeof s.gekozenMateriaalSchema>;
export type GekozenOptie = z.infer<typeof s.gekozenOptieSchema>;
