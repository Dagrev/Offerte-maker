...
export const wizard = {
  ...
  extras: {
    ...
    mm: 'mm',
    daktrim: 'Daktrim en dakranden',
    dakgoot: 'EPDM-dakgoten',
    strekkendeMeter: 'm¹',
    hwa: 'Hemelwaterafvoeren',
    noodoverloop: 'Noodoverlopen',
    doorvoer: 'Dakdoorvoeren (pijpen, ventilatie)',
    lichtkoepel: 'Lichtkoepels en dakramen aansluiten',
    stuks: 'stuks',
    afwerking: 'Afwerking',
    hoogte: 'Hoogte',
    steiger: 'Steiger of hoogwerker nodig',
    garantie: 'Garantie',
    garantieOpties: { '10': '10 jaar', '20': '20 jaar verzekerde garantie' },
  ...
  samenvatting: {
    ...
    hwa: 'Hemelwaterafvoeren',
    noodoverloop: 'Noodoverlopen',
    doorvoer: 'Dakdoorvoeren',
    lichtkoepel: 'Lichtkoepels en dakramen',
    afwerking: 'Afwerking',
    hoogte: 'Hoogte',
