...
// Prijslijst (OFM-018, FE-074). Bewaren en verwijderen invalideren `['prijzen']`. Sinds OFM-048 gebruikt
// de renderer dit alleen nog voor de vaste posten (sectie Overige prijzen); de prijzen van werkzaamheden,
// opties en materialen gaan via `werkzaamheden:bewaar` (api/werkzaamheden.ts).
